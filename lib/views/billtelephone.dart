...
class BillTelephoneScreen extends StatefulWidget{
  @override
  _BillTelephoneScreen createState() => _BillTelephoneScreen();
}

class _BillTelephoneScreen extends State<BillTelephoneScreen> {
                          ...
                          onPressed: (){
                            if(_selectedCompany=="-select account-"){
                              ...
                              BillPayment billpayment=BillPayment(amount: amount.toString(),billno: billnumber,billpaymentid: 0,SessionId: randomstr,
                                  comments: narration,utilityname: "WATER",utilitycompany: _selectedProvider,
                                  MyAccountNumber: _selectedCompany,AccountNumber: _selectedCompany);
